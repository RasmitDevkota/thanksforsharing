...
# Libraries Used
This project was made with assistance from MDL (Material Design Lite) where a use of the library would be more efficient, such as with advanced styling and
