            ...
            document.getElementById("c2c-verified-cards").innerHTML += `
                <div class="demo-card-wide mdl-card mdl-shadow--2dp c2c-content-card">
                    <div class="mdl-card__title c2c-title" style="background-image: url('${imageRef}');">
                        <h2 class="mdl-card__title-text c2c-title-text" style="color: #ededed; background-color: rgba(0, 0, 0, 0.5);">${name}</h2>
                    </div>
                    ...
                    <div class="mdl-card__menu" style="color: #ededed; background-color: rgba(0, 0, 0, 0.5);">
                        $${price}
                    </div>
                </div>
            `;
