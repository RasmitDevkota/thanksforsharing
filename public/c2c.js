    ...
    db.collectionGroup(user.displayName).get().then(function (querySnapshot) {
        querySnapshot.forEach(function (doc) {
            ...
            document.getElementById("c2c-verified-orders").innerHTML += `
                <div id="${name}" class="demo-card-event mdl-card mdl-shadow--2dp c2c-content-card">
...
function verifyOrder(id) {
    var c = confirm("Confirm that this product has been shipped by the seller (not necessarily received)?")
};